...
function showLoader(target: string): void {
  // Loader markup + CSS lives in index.html so it paints on the very first
  // frame, before this module runs. We just find it, ensure it's visible,
  // and update the target/tip text.
  ...
  document.documentElement.classList.add('dp-booting');
...
function hideLoader(): void {
  ...
  document.documentElement.classList.remove('dp-booting');
